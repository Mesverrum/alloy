// Command snmp-discovery — CLI wrapper around internal/snmpdiscovery.
package main
...
func run(argv []string) error {
	...
	snmpCfg := fs.String("snmp-config", "/etc/alloy/snmp-network.yml", "snmp.yml auths")
	fpPath := fs.String("fingerprinters", "/etc/alloy/fingerprinters.yml", "fingerprinters")
	...
	outSD := fs.String("out-file-sd", "/etc/alloy/snmp-file-sd.json", "Prometheus file_sd")
